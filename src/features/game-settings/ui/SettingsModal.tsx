...
function SettingsModal({ gameId, onClose }: Readonly<SettingsModalProps>) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div ref={modalRef} className="rounded-lg bg-white p-4 shadow-lg">
